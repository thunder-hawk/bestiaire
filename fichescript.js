...
const FICHE_SQUELETTE = `
  <div class="fp-header">
    <div class="fp-badge" data-niveau="1"></div>
  ...
  <div class="fp-stats">
    <div class="fp-stat" data-type="pv">
      ...
      <span class="fp-stat-detail">
        Base : <span class="fp-pv-base">220</span> (bonus de niveau : <span class="fp-bonus">+0</span>)
      </span>
    </div>
    <div class="fp-stat" data-type="dps">
      ...
      <span class="fp-stat-total">0</span>
      <span class="fp-stat-detail">
        Base : <span class="fp-dps-base">110</span> (bonus de niveau : <span class="fp-bonus">+0</span>)
      </span>
    </div>
  </div>
